        ...
        properties: {
            ...
            location: {
                ...
                enum: ['NTR Marg', 'Gachibowli', 'Madhapur', 'RTC X Roads', 'Hi-Tech City',
                       ...
                       'Ampa Skywalk, Aminjikarai', 'Villivakkam', 'Mount Road',
                       'Avadi', 'Vadapalani', 'Kolathur', "Parry's",
                       'MI Road', 'Vaishali Nagar', 'Janpath', 'Crystal Palm Mall',
                       'Lal Kothi', 'World Trade Park', 'GT Central Mall',
                       'Phoenix Palassio', 'Riverside Mall', 'Wave Mall',
                       'Hazratganj', 'Sahara Mall', 'SRS Mall', 'Fun Republic Mall',
                       'Oberon Mall', 'Lulu Mall', 'Centre Square Mall', 'MG Road',
                       'Kaloor', 'Forum Mall', 'Padma Junction', 'Chittoor Road',
                       'Treasure Island Mall', 'Magneto Mall', 'Malhar Mega Mall',
                       'Central Mall', 'Phoenix Citadel Mall', 'Rau',
                       'DB City Mall', 'Aura Mall', 'New Market', 'Hoshangabad Road',
                       'Elante Mall', 'Sector 26', 'Sector 17', 'Sector 35', 'Phase 3B2',
                       'VR Mall', 'Rahul Raj Mall', 'Raj Empire Mall', 'City Gold Mall',
                       'Valentine Mall', 'Raghuleela Mall',
                       'Sitabuldi', 'Empress Mall', 'Eternity Mall', 'Mumbai Nagar',
                       'Dharampeth', 'Civil Lines',
                       'Brookefields Mall', 'Fun Republic Mall', 'Prozone Mall',
                       'KG Campus', 'Sathyam Mall', 'Gandhipuram',
                        'Vizag', 'Central Mall', 'Varun Beach Mall', 'Miraj Mall', 'Dwaraka Nagar',
                        'Guwahati',
